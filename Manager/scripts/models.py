...
class Scripts(models.Model):
    ...
    invalid_time = models.DateTimeField(verbose_name=u'失效时间', null=True)
    ...
    issued_success = models.IntegerField(verbose_name=u'下发成功计数', default=-1)
    issued_fail = models.IntegerField(verbose_name=u'下发失败计数', default=-1)
